...
Defined in: [packages/query-db-collection/src/manual-sync.ts:20](https://github.com/sadkebab/db/blob/main/packages/query-db-collection/src/manual-sync.ts#L20)
