...
Defined in: [packages/query-db-collection/src/errors.ts:90](https://github.com/sadkebab/db/blob/main/packages/query-db-collection/src/errors.ts#L90)
...
Defined in: [packages/query-db-collection/src/errors.ts:91](https://github.com/sadkebab/db/blob/main/packages/query-db-collection/src/errors.ts#L91)
