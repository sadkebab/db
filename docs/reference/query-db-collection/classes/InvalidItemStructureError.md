...
Defined in: [packages/query-db-collection/src/errors.ts:48](https://github.com/sadkebab/db/blob/main/packages/query-db-collection/src/errors.ts#L48)
...
Defined in: [packages/query-db-collection/src/errors.ts:49](https://github.com/sadkebab/db/blob/main/packages/query-db-collection/src/errors.ts#L49)
