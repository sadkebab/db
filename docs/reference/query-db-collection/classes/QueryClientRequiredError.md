...
Defined in: [packages/query-db-collection/src/errors.ts:25](https://github.com/sadkebab/db/blob/main/packages/query-db-collection/src/errors.ts#L25)
...
Defined in: [packages/query-db-collection/src/errors.ts:26](https://github.com/sadkebab/db/blob/main/packages/query-db-collection/src/errors.ts#L26)
